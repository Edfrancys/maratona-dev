...
const LoginPage: React.FC = () => {
    ...
    const onSubmitLogin = (data: AuthUserData) => {
        signIn(data)        
    }

    return (
        <form onSubmit={handleSubmit(onSubmitLogin)} className='justify-between pt-4 pb-6' >
            ...
            <div className='px-6 mb-3'>
                <button type='submit' className='py-2 w-full rounded-lg border-2 font-bold text-blue-600 border-blue-600 hover:border-transparent hover:bg-blue-400 hover:text-white'>Login</button>
            </div>
